//въвеждат се 3 цели числса - ден, месец и година и трябва да се определи колко дни остават до края на годината
#include <stdio.h>
#include <stdlib.h>
int main()
{
    int day, year, month, visokosna = 0, month_days;
    int ok;
    int total = 0;
    do {
        ok = 1;
    ...
    while(curr_month <= 12) {
        ...
        if(curr_month == month) total = total + month_days - day;
